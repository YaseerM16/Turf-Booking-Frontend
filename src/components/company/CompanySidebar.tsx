...
const Sidebar: React.FC = () => {
    ...
    return (
        <>
            ...
            <button
                className="md:hidden absolute top-4 left-4 text-gray-800"
                onClick={() => setIsOpen(true)}
            >
                <FiMenu size={24} />
            </button>
            {/* Sidebar */}
            <div className={`fixed md:relative z-50 bg-green-200 min-h-screen p-4 transition-all duration-300
            ${isOpen ? "left-0 w-[80%] sm:w-1/3" : "-left-full"} md:w-1/6 md:block md:left-auto`}>
                    ...
                    <ul className="space-y-4">
                        ...
                        {company?.isApproved ? (
                            <>
                                ...
                                <li className={`font-semibold p-2 rounded ${isActive('/sales-report')} cursor-pointer transition duration-300 ease-in-out hover:bg-green-600 hover:text-white hover:shadow-lg hover:scale-105`}
                                    onClick={() => router.push('/company/sales-report')}>Sales Report</li>
                                <li className={`font-semibold p-2 rounded ${isActive('/turf-management')} cursor-pointer transition duration-300 ease-in-out hover:bg-green-600 hover:text-white hover:shadow-lg hover:scale-105`}
                                    onClick={() => router.push('/company/turf-management')}>Turf Management</li>
                                <li className={`font-semibold p-2 rounded ${isActive('/slot-management')} cursor-pointer transition duration-300 ease-in-out hover:bg-green-600 hover:text-white hover:shadow-lg hover:scale-105`}
                                    onClick={() => router.push('/company/slot-management')}>Slot Management</li>
                                <li className={`font-semibold p-2 rounded ${isActive('/profile')} cursor-pointer transition duration-300 ease-in-out hover:bg-green-600 hover:text-white hover:shadow-lg hover:scale-105`}
                                    onClick={() => router.push('/company/profile')}>Company Profile</li>
                                <li className={`font-semibold p-2 rounded ${isActive('/messages')} cursor-pointer transition duration-300 ease-in-out hover:bg-green-600 hover:text-white hover:shadow-lg hover:scale-105`}
                                    onClick={() => router.push('/company/messages')}>Messages</li>
                            </>
                        ) : (
                            <>
                        ...
                        {loading ? <div className="p-2">Loading...</div> : (
                            <li onClick={handleLogout} className="text-red-500 font-semibold hover:bg-red-200 p-2 rounded cursor-pointer">
                                Logout
                            </li>
                        )}
                    </ul>
